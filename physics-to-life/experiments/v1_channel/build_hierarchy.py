...
def main():
    ...
    ap.add_argument("--form", choices=["eyring", "sigmoid", "B", "coupled", "coupledB", "anchored", "anchoredB", "coupledchain", "coupledfixed", "coupledfixed_a2", "coupledfixed_a5"], default="anchored")
